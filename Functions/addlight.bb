Function addlight%(arg0.rooms, arg1#, arg2#, arg3#, arg4%, arg5#, arg6%, arg7%, arg8%)
    ...
    For local0 = $00 To $13 Step $01
        If (arg0\Field7[local0] = $00) Then
            ...
            entitytexture(arg0\Field9[local0], lightspritetex($00), $00, $00)
            entityblend(arg0\Field9[local0], $03)
            entityparent(arg0\Field9[local0], arg0\Field1, $01)
            Return arg0\Field7[local0]
        EndIf
    Next
    Return $00
End Function
