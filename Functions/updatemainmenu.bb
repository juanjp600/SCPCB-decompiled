    ...
    Else
        ...
        Select mainmenutab
            Case $01
                ...
                If (drawtick((Int ((20.0 * menuscale) + (Float local0))), (Int ((90.0 * menuscale) + (Float local1))), (selectedmode = $00)) <> 0) Then
                    selectedmode = $00
                EndIf
                If (drawtick((Int ((20.0 * menuscale) + (Float local0))), (Int ((120.0 * menuscale) + (Float local1))), (selectedmode = $01)) <> 0) Then
                    selectedmode = $01
                EndIf
                color($FF, $FF, $FF)
                ...
                introenabled = drawtick((Int ((200.0 * menuscale) + (Float local0))), (Int ((160.0 * menuscale) + (Float local1))), introenabled)
                color($FF, $FF, $FF)
                    ...
                    If (currsave <> "") Then
                        ...
                        Else
                            ...
                            For local6 = $01 To len(randomseed) Step $01
                                local11 = (local11 + (Str asc(mid(local11, local6, $01))))
                            Next
                        EndIf
                        ...
                        Next
                        If (local12 > $00) Then
                            currsave = (((currsave + " (") + (Str (local12 + $01))) + ")")
                        EndIf
                        loadentities()
                        initnewgame()
                        mainmenuopen = $00
            ...
            Case $03
                ...
                mousesens = ((slidebar((Int ((240.0 * menuscale) + (Float local0))), (Int ((20.0 * menuscale) + (Float local1))), $96, ((mousesens + 0.5) * 100.0)) / 100.0) - 0.5)
                color($64, $64, $64)
