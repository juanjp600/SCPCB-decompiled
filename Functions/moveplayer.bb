Function moveplayer%()
    ...
    If (noclip <> 0) Then
        rotateentity(collider, entitypitch(camera, $00), entityyaw(camera, $00), 0.0, $00)
        local5 = (local5 * 2.0)
    ...
    Else
        ...
        Else
            ...
            EndIf
        EndIf
        local3 = ((entityyaw(collider, $01) + local3) + 90.0)
        If ((Int local4) <> 0) Then
            translateentity(collider, (cos(local3) * local5), 0.0, (sin(local3) * local5), $01)
        EndIf
        local6 = $00
