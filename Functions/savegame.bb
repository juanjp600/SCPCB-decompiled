Function savegame%(arg0$)
    ...
    writestring(local4, (Str accesscode))
    ...
    For local7 = Each doors
        ...
        writebyte(local4, local7\Field21)
    ...
    For local8 = Each npcs
        ...
        writebyte(local4, (Int local8\Field19))
