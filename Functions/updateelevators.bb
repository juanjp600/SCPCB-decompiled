Function updateelevators#(arg0#, arg1.doors, arg2.doors, arg3%, arg4%, arg5.events)
    ...
    If (((arg1\Field5 = $00) And (arg2\Field5 = $00)) <> 0) Then
        ...
        arg2\Field4 = $01
        If (0.0 > arg0) Then
            debuglog(((("ylh??lt? alas - " + (Str (Abs (entityx(collider, $00) - entityx(arg3, $01))))) + ", ") + (Str (Abs (entityz(collider, $00) - entityz(arg3, $01))))))
            arg0 = (arg0 - fpsfactor)
            ...
            EndIf
        Else
            debuglog(((("alhaalta yl?s - " + (Str (Abs (entityx(collider, $00) - entityx(arg4, $01))))) + ", ") + (Str (Abs (entityz(collider, $00) - entityz(arg4, $01))))))
            arg0 = (arg0 + fpsfactor)
