Function createdoor.doors(arg0%, arg1#, arg2#, arg3#, arg4#, arg5%, arg6%, arg7%, arg8%, arg9$)
    Local local0.doors
    Local local1%
    local0 = (New doors)
    If (arg7 <> 0) Then
    ...
    For local1 = $00 To $01 Step $01
        If (arg9 <> "") Then
            local0\Field3[local1] = copymesh(buttoncodeobj, $00)
        ElseIf (arg8 <> 0) Then
    ...
    If (local0\Field1 <> $00) Then
        ...
        EndIf
        entityparent(local0\Field1, arg6, $01)
    EndIf
    positionentity(local0\Field2, arg1, arg2, arg3, $00)
    entityparent(local0\Field2, arg6, $01)
    entityparent(local0\Field0, arg6, $01)
