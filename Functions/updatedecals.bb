Function updatedecals%()
    ...
    For local0 = Each decals
        ...
        If (0.0 < local0\Field9) Then
            local0\Field9 = max((local0\Field9 - fpsfactor), 5.0)
        EndIf
        If ((((0.0 >= local0\Field2) Or (0.0 >= local0\Field4)) Or ((0.0 < local0\Field9) And (10.0 > local0\Field9))) <> 0) Then
